...
{
    private sealed class TestVersionedEntity : VersionedEntity<TestVersionedEntity>
    {
        public TestVersionedEntity() : base() { }
    ...
    public void ParameterizedConstructorSetsProperties()
    {
        ...
        var entity = new TestVersionedEntity(id, partitionKey, rowKey, ownerId, tenantId, createdBy, createdOn, timestamp, version, previousVersionId);
